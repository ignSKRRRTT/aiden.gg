      ...
      >
        <div className={`p-4 flex flex-col ${gradient} from-primary to-secondary rounded-lg border-1 border-accent shadow-2xl shadow-background items-center`}>
          ...
          <div className="flex flex-row gap-2 w-full mt-3">
            <Link href={url} target="_blank" className="bg-primary hover:bg-secondary duration-300 border-1 border-accent px-2 py-1.5 w-1/2 text-lg font-medium flex items-center justify-center rounded-lg">
              Visit Website
            </Link>
            <button onClick={() => setModalOpen(true)} className="bg-primary hover:bg-secondary duration-300 border-1 border-accent px-2 py-1.5 w-1/2 text-lg font-medium flex items-center justify-center rounded-lg">
              Learn More
            </button>
          </div>
        </div>
