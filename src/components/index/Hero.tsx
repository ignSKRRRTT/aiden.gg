...
export default function Hero({ inView, descRef }: { inView: boolean, descRef: any }) {
  return (
      ...
      <section className="max-w-4xl w-full flex flex-col mx-auto pt-44">
        ...
        >
          <h1 className="font-leaguespartan font-bold lg:text-7xl md:text-6xl sm:text-5xl text-4xl text-text">
            Hey, I&apos;m Q<span className="sm:hidden inline-block animate-wave ml-2">👋</span><span className="font-leaguespartan font-bold text-xl text-text brightness-50 italic sm:inline flex"> aka Xpert</span><span className="sm:inline-block hidden animate-wave ml-2">👋</span>
          </h1>
          <p className="font-leaguespartan font-semibold lg:text-3xl md:text-2xl sm:text-xl text-lg text-text">
            {inView &&
              <Typewriter
                options={{
                  delay: 30,
                  strings: ["I'm an 404 year old new developer located in New Mexico "],
                  loop: false,
                  autoStart: true,
          ...
          <ul className="flex flex-row flex-wrap gap-2 mt-2">
            <SocialIcon
              url="https://www.youtube.com/channel/UCRQYi5az5HaElmBaI-Nb0sQ"
            ...
            />
            <SocialIcon
              url="https://discord.gg/EYdbgh3Z29"
    ...
    icon={
        <svg viewBox="-8 -8 16 16" className='w-7 h-7 fill-black' shapeRendering="crispEdges">
            ...
            <path d="M15.312,16.583a.5.5,0,0,1-.251-.068,9.777,9.777,0,0,0-7.295-1.033.5.5,0,0,1-.245-.97,10.768,10.768,0,0,1,8.043,1.139a.5.5,0,0,1-.252.932Z"></path>
